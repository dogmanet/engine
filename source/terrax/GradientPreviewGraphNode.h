#ifndef __GRADIENTPREVIEWGRAPHNODE_H
#define __GRADIENTPREVIEWGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>
//#include <mtrl/IXMaterialSystem.h>

class CGradientPreviewGraphNodeData;
class CGradientPreviewGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CGradientPreviewGraphNode(IXCore *pCore);
	~CGradientPreviewGraphNode();

	XIMPLEMENT_VERSION(IXRENDERGRAPHNODE_VERSION);

	const char* XMETHODCALLTYPE getName() const override
	{
		return("xGradientPreview");
	}
