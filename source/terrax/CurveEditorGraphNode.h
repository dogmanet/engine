#ifndef __CURVEEDITORGRAPHNODE_H
#define __CURVEEDITORGRAPHNODE_H

#include <xcommon/render/IXRender.h>
#include <xcommon/IXCore.h>
//#include <mtrl/IXMaterialSystem.h>

class CCurveEditorGraphNodeData;
class CCurveEditorGraphNode final: public IXUnknownImplementation<IXRenderGraphNode>
{
public:
	CCurveEditorGraphNode(IXCore *pCore);
	~CCurveEditorGraphNode();
